...
pub use app::{
    build_runtime_plugin_state_with_loader, collect_session_prompt_history, detect_broad_cwd,
    enforce_broad_cwd_policy, init_claude_md, init_json_value, normalize_permission_mode,
    render_config_json, render_config_report, render_export_text, render_memory_json,
    render_memory_report, render_prompt_history_report, render_repl_help,
    render_version_report, parse_history_count, resolve_export_path, run_export,
    run_init, run_stale_base_preflight, LiveCli, RuntimeMcpState, run_repl, print_help,
};
pub use args::{
    format_connected_line, format_unknown_slash_command, looks_like_slash_command_token,
    omc_compatibility_note_for_unknown_slash_command, parse_args, parse_permission_mode_arg,
    permission_mode_from_label, provider_label, resume_command_can_absorb_token,
    resolve_model_alias, run_doctor, run_mcp_serve, run_spawn_visible_worker,
    run_supervisor_status, run_worker_loop, run_worker_state, suggest_slash_commands,
    filter_tool_specs, render_doctor_report, resolve_model_alias_with_config,
    resolve_repl_model, try_resolve_bare_skill_prompt, default_permission_mode,
    AllowedToolSet, CliAction, CliOutputFormat, DEFAULT_MODEL,
    LATEST_SESSION_REFERENCE, LEGACY_SESSION_EXTENSION, PRIMARY_SESSION_EXTENSION,
    SESSION_REFERENCE_ALIASES, STUB_COMMANDS,
};
pub use format::{
    format_auto_compaction_notice, format_compact_report, format_cost_report,
    format_model_report, format_model_switch_report, format_permissions_report,
    format_permissions_switch_report, format_resume_report, print_help_topic, render_help_topic,
    render_resume_usage, LocalHelpTopic,
};
pub use session_mgr::{
    confirm_session_deletion, create_managed_session_handle, delete_managed_session,
    list_managed_sessions, load_session_reference, new_cli_session, resolve_session_reference,
    resume_session, ResumeCommandOutcome, SessionHandle,
};
...
pub(crate) use tui::tool_panel::{
    ...
    format_tool_call_start, format_tool_result, response_to_events,
...
pub use runtime::session_control::ManagedSessionSummary;
pub use runtime::{
...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match parse_args(&args)? {
        ...
        CliAction::Status {
            ...
            permission_mode,
            output_format,
        } => app::print_status_snapshot(&model, permission_mode, output_format)?,
        ...
        CliAction::HelpTopic(topic) => format::print_help_topic(topic),
...
UU conflicted.rs",
    ...
    fn build_runtime_runs_plugin_lifecycle_init_and_shutdown() {
        ...
        let loader = ConfigLoader::new(&workspace, &config_home);
        let runtime_config = loader.load().expect("runtime config should load");
        let runtime_plugin_state = build_runtime_plugin_state_with_loader(&workspace, &loader, &runtime_config)
                .expect("plugin state should load");
